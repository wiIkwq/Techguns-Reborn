...
- restoring item, block, armor, and legacy model rendering
- rebuilding the project baseline before gameplay systems are reintroduced
...
- visual consistency across all complex items and block-items
...
1. Finish the current visual polish pass for weapons, armor previews, held transforms, and block-items.
2. Lock a stable visual milestone for the alpha branch.
3. Rebuild the gun and projectile framework on top of the cleaned-up 1.20.1 structure.
