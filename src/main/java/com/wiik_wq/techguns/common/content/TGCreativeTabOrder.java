...
public final class TGCreativeTabOrder {
    ...
    private static final List<String> LEGACY_BLOCK_ORDER = List.of(
            ...
            "panel_large_border_slab",
            "panel_large_border_wall",
            "steelframe_blue_stairs",
            "steelframe_blue_slab",
            "steelframe_blue_wall",
            "steelframe_dark_stairs",
            "steelframe_dark_slab",
            "steelframe_dark_wall",
            "concrete_brown_stairs",
            "concrete_brown_slab",
            "concrete_brown_wall",
            "concrete_brown_light_stairs",
            "concrete_brown_light_slab",
            "concrete_brown_light_wall",
            "concrete_grey_stairs",
            "concrete_grey_slab",
            "concrete_grey_wall",
            "concrete_grey_dark_stairs",
            "concrete_grey_dark_slab",
            "concrete_grey_dark_wall",
            "concrete_brown_light_scaff_stairs",
            "concrete_brown_light_scaff_slab",
            "concrete_brown_light_scaff_wall",
            "nethermetal_panel_stairs",
            "nethermetal_panel_slab",
            "nethermetal_panel_wall",
            "nethermetal_grate1_stairs",
            "nethermetal_grate1_slab",
            "nethermetal_grate1_wall",
            "nethermetal_grate2_stairs",
            "nethermetal_grate2_slab",
            "nethermetal_grate2_wall",
            "nethermetal_grey_dark_stairs",
            "nethermetal_grey_dark_slab",
            "nethermetal_grey_dark_wall",
            "nethermetal_grey_stairs",
            "nethermetal_grey_slab",
            "nethermetal_grey_wall",
            "nethermetal_grey_tiles_stairs",
            "nethermetal_grey_tiles_slab",
            "nethermetal_grey_tiles_wall",
            "nethermetal_border_red_stairs",
            "nethermetal_border_red_slab",
            "nethermetal_border_red_wall",
            "nethermetal_plate_black_stairs",
            "nethermetal_plate_black_slab",
            "nethermetal_plate_black_wall",
            "nethermetal_plate_red_stairs",
            "nethermetal_plate_red_slab",
            "nethermetal_plate_red_wall",
            "nethermetal_border_lava_stairs",
            "nethermetal_border_lava_slab",
            "nethermetal_border_lava_wall",
            "hole",
            "soldier_spawn",
            "neontubes2",
            "neontubes2_rotated",
