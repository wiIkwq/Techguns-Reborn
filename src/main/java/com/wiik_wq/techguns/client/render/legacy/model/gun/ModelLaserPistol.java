...
public class ModelLaserPistol extends LegacyMultipartModel {
    public LegacyModelRenderer Barrel1;
    ...
    public LegacyModelRenderer BottomRound;
    public LegacyModelRenderer grip3;
    public LegacyModelRenderer BarrelFront;
    public LegacyModelRenderer BottomFront;
    public LegacyModelRenderer Front1;
    public LegacyModelRenderer Front2;
    public LegacyModelRenderer Barrel4;
    public LegacyModelRenderer Barrel5;
    public LegacyModelRenderer Cylinder1;
    public LegacyModelRenderer Cylinder2;
    public LegacyModelRenderer Side1;
    public LegacyModelRenderer CylinderFront;
    public LegacyModelRenderer TopRound;

    public ModelLaserPistol() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.Grip1 = new LegacyModelRenderer(this, 37, 7);
        ...
        this.BottomFront = new LegacyModelRenderer(this, 28, 10);
        ...
        this.Barrel5 = new LegacyModelRenderer(this, 9, 26);
        this.Barrel5.setRotationPoint(-2.0F, -1.5F, 6.0F);
        this.Barrel5.addBox(0.0F, 0.0F, 0.0F, 3, 1, 4, 0.0F);
        this.Cylinder2 = new LegacyModelRenderer(this, 19, 0);
        ...
        this.Barrel2 = new LegacyModelRenderer(this, 44, 22);
        this.Barrel2.setRotationPoint(-3.0F, -1.2F, -3.0F);
        this.Barrel2.addBox(0.0F, 0.0F, 0.0F, 5, 5, 5, 0.0F);
        this.Cylinder1 = new LegacyModelRenderer(this, 19, 0);
        ...
        this.Front1 = new LegacyModelRenderer(this, 34, 0);
        this.Front1.setRotationPoint(-1.3F, 4.3F, -2.0F);
        this.Front1.addBox(0.0F, 0.0F, 0.0F, 0, 4, 1, 0.0F);
        this.Side1 = new LegacyModelRenderer(this, 17, 8);
