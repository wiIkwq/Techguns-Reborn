...
public class ModelAS50Mag extends LegacyMultipartModel {
	...
	public ModelAS50Mag(boolean empty) {
		...
		Magazine01 = new LegacyModelRenderer(this, 0, 19);
		...
		Magazine03 = new LegacyModelRenderer(this, 17, 10);
		...
		if (!empty) {
			Bullet2 = new LegacyModelRenderer(this, 0, 0);
		...
		Magazine02 = new LegacyModelRenderer(this, 0, 12);
		...
		if (!empty) {
			Bullet = new LegacyModelRenderer(this, 13, 0);
