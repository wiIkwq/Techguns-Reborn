...
public class ModelLmgMag extends LegacyMultipartModel {
	// fields
	...
	public ModelLmgMag(boolean empty) {
		...
		Mag03 = new LegacyModelRenderer(this, 0, 0);
		...
		if (!empty) {
			Bullet06 = new LegacyModelRenderer(this, 41, 20);
			...
			Bullet05 = new LegacyModelRenderer(this, 41, 20);
			...
			Bullet04 = new LegacyModelRenderer(this, 41, 20);
			...
			Bullet03 = new LegacyModelRenderer(this, 41, 20);
			...
			Bullet02 = new LegacyModelRenderer(this, 41, 20);
			...
			Bullet01 = new LegacyModelRenderer(this, 41, 20);
