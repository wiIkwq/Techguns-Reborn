...
public class ModelLMG extends LegacyMultipartModel {

	 //fields
   LegacyModelRenderer Grip1;
   LegacyModelRenderer Trigger01;
   LegacyModelRenderer Trigger02;
   LegacyModelRenderer Grip02;
   LegacyModelRenderer IronSight01;
   LegacyModelRenderer Bullet01;
   LegacyModelRenderer IronSight02;
   LegacyModelRenderer Barrelpart;
   LegacyModelRenderer Mag03;
   LegacyModelRenderer Grip01;
   LegacyModelRenderer BarrelRails04;
   LegacyModelRenderer Stock01;
   LegacyModelRenderer Receiver07;
   LegacyModelRenderer Stock02;
   ...
   LegacyModelRenderer Mag01;
   LegacyModelRenderer Mag02;
   LegacyModelRenderer Barrel03;
   LegacyModelRenderer Bullet06;
   LegacyModelRenderer Bullet05;
   LegacyModelRenderer Bullet04;
   LegacyModelRenderer Bullet03;
   LegacyModelRenderer Bullet02;
   LegacyModelRenderer Receiver01;
   LegacyModelRenderer Receiver02;
   LegacyModelRenderer Barrel;
   LegacyModelRenderer Receiver03;
   LegacyModelRenderer Receiver04;
   LegacyModelRenderer RedDot;
   LegacyModelRenderer TopRails;
   LegacyModelRenderer Holo01;
   LegacyModelRenderer Holo02;
   LegacyModelRenderer Holo06;
   LegacyModelRenderer Holo03;
   LegacyModelRenderer Holo04;
   LegacyModelRenderer Holo05;
   LegacyModelRenderer Receiver08;
   LegacyModelRenderer Stock06;
   LegacyModelRenderer Stock07;
   LegacyModelRenderer IronSight03;
   LegacyModelRenderer Barrel02;
   LegacyModelRenderer Receiver05;
   LegacyModelRenderer Bullet00;
   LegacyModelRenderer Bullet07;
 ...
 public ModelLMG()
 {
   ...
   textureHeight = 128;
     ...
     Trigger01 = new LegacyModelRenderer(this, 83, 21);
     ...
     Trigger02 = new LegacyModelRenderer(this, 83, 17);
     ...
     Grip02 = new LegacyModelRenderer(this, 56, 6);
     ...
     IronSight01 = new LegacyModelRenderer(this, 5, 39);
     ...
     Bullet01 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet00 = new LegacyModelRenderer(this, 0, 26);
     ...
     IronSight02 = new LegacyModelRenderer(this, 0, 34);
     ...
     Barrelpart = new LegacyModelRenderer(this, 0, 39);
     ...
     Mag03 = new LegacyModelRenderer(this, 39, 66);
     ...
     Grip01 = new LegacyModelRenderer(this, 53, 0);
     ...
     BarrelRails04 = new LegacyModelRenderer(this, 42, 33);
     ...
     Stock01 = new LegacyModelRenderer(this, 106, 25);
     ...
     Receiver07 = new LegacyModelRenderer(this, 92, 21);
     ...
     Stock02 = new LegacyModelRenderer(this, 110, 48);
     ...
     Stock04 = new LegacyModelRenderer(this, 79, 64);
     ...
     Stock05 = new LegacyModelRenderer(this, 119, 68);
     ...
     Stock03 = new LegacyModelRenderer(this, 108, 39);
     ...
     Trigger03 = new LegacyModelRenderer(this, 83, 26);
     ...
     Receiver06 = new LegacyModelRenderer(this, 106, 13);
     ...
     Bullet07 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet06 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet05 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet04 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet03 = new LegacyModelRenderer(this, 0, 26);
     ...
     Bullet02 = new LegacyModelRenderer(this, 0, 26);
     ...
     Receiver01 = new LegacyModelRenderer(this, 54, 13);
     ...
     Receiver02 = new LegacyModelRenderer(this, 54, 34);
     ...
     Barrel = new LegacyModelRenderer(this, 0, 26);
     ...
     Receiver03 = new LegacyModelRenderer(this, 66, 81);
     ...
     Receiver04 = new LegacyModelRenderer(this, 31, 47);
     ...
     RedDot = new LegacyModelRenderer(this, 105, 10);
     ...
     TopRails = new LegacyModelRenderer(this, 0, 0);
     ...
     Holo04 = new LegacyModelRenderer(this, 105, 0);
     ...
     Holo05 = new LegacyModelRenderer(this, 104, 8);
     ...
     Receiver08 = new LegacyModelRenderer(this, 98, 81);
     ...
     Stock06 = new LegacyModelRenderer(this, 102, 65);
     ...
     Stock07 = new LegacyModelRenderer(this, 102, 65);
     ...
     IronSight03 = new LegacyModelRenderer(this, 0, 39);
     ...
     Barrel02 = new LegacyModelRenderer(this, 22, 31);
     ...
     Receiver05 = new LegacyModelRenderer(this, 28, 12);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3,
			float f4, float f5, int ammoLeft, float reloadProgress, ItemDisplayContext transformType, int part,
   ...
   if (reloadProgress==0f || reloadProgress > 0.5f) {
	...
	protected void animateBullet(LegacyModelRenderer bullet, float scale, ItemDisplayContext transform, LegacyModelRenderer targetPos, float recoilProgress) {
		if ( transform == ItemDisplayContext.FIRST_PERSON_RIGHT_HAND || transform == ItemDisplayContext.FIRST_PERSON_LEFT_HAND) {
			...
			LegacyGlStateManager.translate(x*scale, y*scale, z*scale);
			bullet.render(scale);
